...
const ReportsDashboard = () => {
  ...
  const stats = [
    { title: 'Total Tasks', value: '735', change: '+12.5%', icon: DocumentTextIcon, color: 'from-blue-500 to-blue-600', bgColor: 'bg-blue-50', textColor: 'text-blue-600' },
    { title: 'Completion Rate', value: '87.2%', change: '+5.2%', icon: CheckCircleIcon, color: 'from-green-500 to-green-600', bgColor: 'bg-green-50', textColor: 'text-green-600' },
    { title: 'Active Users', value: '142', change: '+8', icon: UserGroupIcon, color: 'from-purple-500 to-purple-600', bgColor: 'bg-purple-50', textColor: 'text-purple-600' },
    { title: 'Avg. Response', value: '2.4d', change: '-0.3d', icon: ClockIcon, color: 'from-yellow-500 to-yellow-600', bgColor: 'bg-yellow-50', textColor: 'text-yellow-600' },
  ];
